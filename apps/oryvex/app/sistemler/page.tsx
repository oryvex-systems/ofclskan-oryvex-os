...
export default async function SystemsPage(){
  ...
  const active = systems.filter((item)=>item.status === "active").length;
  ...
  return <main className="page-shell">
    ...
    <section className="system-list">
      ...
      {systems.length === 0 && <article className="glass-card"><h2>Çalışma alanı bulunamadı</h2><p className="section-subtitle">Bu hesabın henüz bir ORYVEX sistemine erişimi yok.</p></article>}
    </section>
